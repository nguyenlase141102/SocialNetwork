...
public class DeleteCommentServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String idComment = request.getParameter("hiddenIdComment");
            int id_interaction = Integer.parseInt(idComment);
            
            if (interAccountDAO.deleteCommentAccount(id_interaction)) {
                if (interDAO.deleteComment(id_interaction)) {
                    url = LOADHOMEPAGE;
                }
            ...
            System.err.println("Error messages(Delete comment ): " + e.getMessage());
        }
    }
